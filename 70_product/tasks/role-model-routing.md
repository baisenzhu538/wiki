...
> ⚠️ **现状注记（2026-09-04 小昭更新）**：下文「一、现状盘点」表格为 **2026-08-09 快照**，此后 8/30-9/1 主力已迁智谱 GLM、9/4 段王爷并入批次——**当前模型配置见 `20_memory/2026-09-04-duanwangye-glm-migration.md` 第二节「全厂模型现状」**（Windows 侧 config.yaml 实测为准）。
>
