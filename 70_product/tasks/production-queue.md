...
| 6 | `laowantong-batch-2026-06-20-wave3` | 老顽童批量工单第 3 波：P1 深度补全 | pending_review | 老顽童(WorkBuddy) | 14 | 依赖 wave2 完成（已 reviewed，解锁） | `laowantong-batch-2026-06-20.md` | WorkBuddy 老顽童完成全波次：A 门禁 5 张 ✅ + 3.1 建模 5 张 ✅ + 3.2 综合卡 9 张 ✅ + 3.3 口述标注 9 张 ✅ + 3.4 药柜剥离 4 文件 ✅；全 14 张 `kdo pre-submit` 通过（14 passed/0 failed），待欧阳锋终审 |
| 7 | `task_20260628_laowantong-dark-knowledges-batch8` | dark-knowledges 第八批清零：补齐 10 张问题 dk 卡 | claimed-workbuddy | 老顽童(WorkBuddy) | 10 | 依赖 wave3 完成（已 pending_review，解锁） | `task_20260628_laowantong-dark-knowledges-batch8.md` | WorkBuddy 老顽童领取；补齐 10 张 dk 卡缺失 section，使 dark-knowledges 目录 lint ERROR 归零 |
