...
| 9 | `laowantong-batch-2026-06-20-wave5` | 老顽童批量工单第 5 波：新域建设 | queued | WorkBuddy 老顽童（预分配） | ~11 | 依赖 wave4 完成（已 reviewed，解锁） | `laowantong-batch-2026-06-20.md` | WorkBuddy 可开始生产；具体卡数见源文件 |
