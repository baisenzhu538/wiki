...
| 471 | `task_20260823_huangyaoshi-l1-capture-scheduling` | L1 采集投入运行最小闭环（P1：常驻调度30min+体积红线） | queued | huangyaoshi | 计划任务+体积监控+verify联动 | **老朱已拍板常驻注册（2026-08-23「L1 全量采集 30 分钟一跑」）——可开工** | `60_feedback/tasks/task_20260823_huangyaoshi-l1-capture-scheduling.md` | 与探针错峰；失败可见禁静默；L3=次日回放抽查；欧阳锋终审 |
