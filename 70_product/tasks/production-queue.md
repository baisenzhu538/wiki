...
| 28 | `task_20260629_kimi-lint-content-debt-by-domain` | lint 内容债按 domain 分批清理 | claimed-kimi | 老顽童(Hermes) | ~3255 WARNING / 14 个子任务 | 依赖 #27 reviewed | `60_feedback/tasks/task_20260629_kimi-lint-content-debt-by-domain.md` | 本轮已处理 31 个 WARNING：3 张 ai-collaboration 卡补 Critique 外部反对者 + 8 个 title_count_mismatch + 2 个 When NOT to Use copy-paste + 32 个 Wiki page 无可见来源；剩余 3255 WARNING 待继续按 domain 分批处理；body 过短因清理空 section 从 80 激增至 651，需下一轮回填 |
