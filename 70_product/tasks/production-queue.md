...
| 212 | task_20260727_wangyuyan-rrf-tag-mcp | RRF tag维度匹配+MCP标签暴露：RRF融合感知tags维度智能排序+MCP search返回tags字段。小昭不看全文就能判断卡片适用性 | pending_review | huangyaoshi | 2项infra | 依赖#211 Phase2精标覆盖率 | 60_feedback/tasks/task_20260727_wangyuyan-rrf-tag-mcp.md |
