...
| 18 | `task_20260628_laowantong-link-repair-b1-frontmatter-related` | B1：frontmatter `related` 字段 src_unknown 占位清理 | pending_review | 老顽童(WorkBuddy) | 256 | 依赖 Batch 2-C reviewed | `60_feedback/tasks/task_20260628_laowantong-link-repair-b1-frontmatter-related.md` | 老顽童已完成：256 文件 1947 src_unknown 清零 + 1190 pending_unknown 补入；`kdo lint` 0 ERROR；20/20 抽检通过；4/4 pre-submit PASS；待欧阳锋终审 |
| 19 | `task_20260628_laowantong-link-repair-b2-synthesis-section` | B2：Synthesis section 死链/占位清理 | claimed-laowantong | 老顽童(WorkBuddy) | 100-200 | 依赖 Batch 2-C reviewed | `60_feedback/tasks/task_20260628_laowantong-link-repair-b2-synthesis-section.md` | 老顽童已领取；必须人工逐张审核；Synthesis 出链 ≥2；批量提交前 `--expect-changes` 门禁 |
