...
| 3 | `task_20260627_laowantong-channel-growth-cards` | 渠道增长域卡片化（含 2 张跨域桥接卡） | queued | - | 16-17 | 依赖 wave1 完成 | `task_20260627_laowantong-channel-growth-cards.md` | 含单元模型+精益创业桥接 |
...
> **当前总待生产卡数**：约 90 张（含历史批量工单 62 张 + 新任务 28-29 张）。
