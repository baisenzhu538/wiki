...
| 6 | `laowantong-batch-2026-06-20-wave3` | 老顽童批量工单第 3 波：P1 深度补全 | pending_review | 老顽童(WorkBuddy) | 14 | 依赖 wave2 完成（已 reviewed，解锁） | `review_20260628_ouyangfeng-wave3.md` | WorkBuddy 老顽童完成全波次；14 张卡 `kdo pre-submit` 通过；欧阳锋审查任务单已创建，待终审 |
| 7 | `task_20260628_laowantong-dark-knowledges-batch8` | dark-knowledges 第八批清零：补齐 10 张问题 dk 卡 | pending_review | 老顽童(WorkBuddy) | 10 | 依赖 wave3 完成（已 pending_review，解锁） | `task_20260628_laowantong-dark-knowledges-batch8.md` | WorkBuddy 老顽童完成：8 张 dk 卡 `---# 标题` 粘连修复；10 张 pre-submit 全通过（10 passed/0 failed）；dark-knowledges 目录 lint ERROR 归零；10 张卡均有标准 6 段 section；待欧阳锋抽检 |
| 8 | `laowantong-batch-2026-06-20-wave4` | 老顽童批量工单第 4 波：P2 清理 | claimed-hermes | Hermes 老顽童 | ~12 | 依赖 wave3 reviewed + 第八批 reviewed（未解锁） | `laowantong-batch-2026-06-20.md` | Hermes 负责；队列锁已上线，可先读素材做准备，等 wave3+第八批 reviewed 后正式生产 |
...
| 12 | `task_20260628_laowantong-case-section-standardization` | 渠道增长域 10 张 case + 1 张 dk section 标准化 | pending_review | Kimi 老顽童 | 11 | 无 | `task_20260628_laowantong-case-section-standardization.md` | P1；Kimi 老顽童实际完成；10 张 case 卡 + 1 张 dk 卡 section 已对齐 lint 新标准；`kdo pre-submit` 8/8 通过；待欧阳锋抽检 |
