...
| 28 | `task_20260629_kimi-lint-content-debt-by-domain` | lint 内容债按 domain 分批清理 | claimed-kimi | 老顽童(Hermes) | ~3286 WARNING / 14 个子任务 | 依赖 #27 reviewed | `60_feedback/tasks/task_20260629_kimi-lint-content-debt-by-domain.md` | 按 domain 分 14 批处理剩余内容债（copy-paste + L2 深度 + body 过短等）；每批独立 `kdo lint --domain <name>` |
