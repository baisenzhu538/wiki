...
| 210 | task_20260726_wangyuyan-private-board | 私董会卡片化：3张（主持SOP七步流程+王非跨年诊断案例+赞助商三层定价法）。P2不阻塞主线 | pending_review | laowantong | 3张 | 无 | 60_feedback/tasks/task_20260726_wangyuyan-private-board.md |
...
| 212 | task_20260727_wangyuyan-rrf-tag-mcp | RRF tag维度匹配+MCP标签暴露：RRF融合感知tags维度智能排序+MCP search返回tags字段。小昭不看全文就能判断卡片适用性 | claimed-huangyaoshi | huangyaoshi | 2项infra | 依赖#211 Phase2精标覆盖率 | 60_feedback/tasks/task_20260727_wangyuyan-rrf-tag-mcp.md |
