...
| 10 | `task_20260628_hermes-lint-baseline-cleanup-batch1` | Hermes lint 基线清理 Batch 1：机械性 frontmatter 修复 | claimed-hermes | Hermes 老顽童 | 659（安全机械修复） | 无（与 wave5 审核并行） | `60_feedback/tasks/task_20260628_hermes-lint-baseline-cleanup-batch1.md` | 从 697 个 lint ERROR 中挑出 659 个可机械修复的 frontmatter 错误；辅助脚本已全量应用，frontmatter parse 类 ERROR 已清零；剩余 690 个为内容/section/source_refs 类错误，需后续任务处理 |
