...
| 21 | `task_20260628_laowantong-wave6-decision-science-systematization` | Wave 6-A：决策科学域系统化 | pending_review | 老顽童(Hermes) | 5 | 依赖 Wave 6 诊断 reviewed | `60_feedback/tasks/task_20260628_laowantong-wave6-decision-science-systematization.md` | 老顽童已完成：1 index 升级 + 2 framework + 1 dk + 1 case 新建；5/5 kdo pre-submit PASS；决策科学域 reviewed 从 14→18 |
| 22 | `task_20260628_laowantong-wave6-demand-analysis-deepening` | Wave 6-B：需求分析域深化 | pending_review | 老顽童(Hermes) | 5 | 依赖 Wave 6 诊断 reviewed | `60_feedback/tasks/task_20260628_laowantong-wave6-demand-analysis-deepening.md` | 老顽童已完成：1 index + 2 case + 1 framework + 1 dk 新建；5/5 kdo pre-submit PASS；需求分析域 reviewed 从 10→15 |
