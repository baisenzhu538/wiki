...
| 20 | `task_20260628_laowantong-link-repair-b3-island-cards` | B3：孤岛卡片 `kdo link-suggest` 批量推荐 | claimed-laowantong | 老顽童(WorkBuddy) | 50-100 | 依赖 B1/B2 完成后启动 | `60_feedback/tasks/task_20260628_laowantong-link-repair-b3-island-cards.md` | 老顽童已领取；半自动：扫描孤岛 → kdo link-suggest → 人工审核 → 写入 |
