...
| 46 | `task_20260702_huangyaoshi-kdo-pipeline-dashboard` | kdo pipeline 管线可视化 Dashboard | pending_review | 黄药师 | 1 个 CLI 命令 | 无；Sprint 6 lake transparency 基建 | `60_feedback/tasks/task_20260702_huangyaoshi-kdo-pipeline-dashboard.md` | 新增 `kdo pipeline`，按 CAPTURE→INGEST→PRODUCE→SHIP→WIKI 五段展示 KDO 管线健康度；自动检测 inbox/enrich/review 瓶颈并给建议；欧阳锋审查中 |
