...
|| 8 | `laowantong-batch-2026-06-20-wave4` | 老顽童批量工单第 4 波：新域建设 | reviewed | Hermes 老顽童 | 15 | 已解锁（wave3 + 第八批均 reviewed） | `review_20260628_ouyangfeng-wave4.md` | Hermes 完成；4.2 Master 域 7 张卡规范化 + 4.1 调研方法论域 8 张卡新建；15 张全部 pre-submit 通过；待欧阳锋终审 |
