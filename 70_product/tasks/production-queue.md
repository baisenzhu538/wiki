...
| 9 | `laowantong-batch-2026-06-20-wave5` | 老顽童批量工单第 5 波：外部探索三个新盲区 | pending_review | WorkBuddy 老顽童 | 12 | 依赖 wave4 完成（已 reviewed，解锁） | `review_20260628_ouyangfeng-wave5.md` | WorkBuddy 已完成全波次；12 张卡 `kdo pre-submit` 全部通过（12/12 passed）；欧阳锋审查任务单已创建（`60_feedback/tasks/review_20260628_ouyangfeng-wave5.md`），待终审 |
| 10 | `task_20260628_hermes-lint-baseline-cleanup-batch1` | Hermes lint 基线清理 Batch 1：机械性 frontmatter 修复 | queued | Hermes 老顽童 | 659（安全机械修复） | 无（与 wave5 审核并行） | `60_feedback/tasks/task_20260628_hermes-lint-baseline-cleanup-batch1.md` | 从 697 个 lint ERROR 中挑出 659 个可机械修复的 frontmatter 错误；不处理 128 个需内容判断的 unsafe 文件；预期 ERROR 降至 ~128 |
