...
| 4 | `task_20260627_laowantong-lanyi-panproduct-organization` | 兰毅泛产品组织化 + 泛产品设计域升级 | pending_review | - | 12 | 无 | `task_20260627_laowantong-lanyi-panproduct-organization.md` | 12 张卡已生产/升级并通过 `kdo pre-submit`；4 张 P0 卡已完成自攻击修复；待欧阳锋终审 |
...
| 7 | `task_20260628_laowantong-dark-knowledges-batch8` | dark-knowledges 第八批清零：补齐 10 张问题 dk 卡 | claimed-workbuddy | 老顽童(WorkBuddy) | 10 | 依赖 wave3 完成（已 pending_review，部分解锁） | `task_20260628_laowantong-dark-knowledges-batch8.md` | WorkBuddy 老顽童领取；补齐 10 张 dk 卡缺失 section，使 dark-knowledges 目录 lint ERROR 归零；待 wave3 reviewed 后 wave4 正式解锁 |
