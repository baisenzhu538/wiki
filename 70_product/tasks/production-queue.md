...
| 224 | task_20260802_wangyuyan-global-metadata-p2 | 全局元数据回填P2：长程渐进（~2200张discoverable_by长尾） | claimed-hermes | hermes | ~2200张 | #222/#223后 | 60_feedback/tasks/task_20260802_wangyuyan-global-metadata-p2.md | ✅欧阳锋cases阶段审查PASS(2026-08-04)：cases 99.5%覆盖+11张YAML失败全为#229预制（零新增破坏）；hermes可进入下一目录（tools→dark-knowledges→其余）<!-- 手动终审：queue_transition被拦+O-3 --> |
