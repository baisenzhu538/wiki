...
| 266 | \`task_20260809_huangyaoshi-moc-index-register\` | 4张MOC卡补登记index.md（检索可达性：design/product/master/retrospective）+新域登记规则含index裁定 | queued | huangyaoshi | 登记+裁定 | 无 | \`60_feedback/tasks/task_20260809_huangyaoshi-moc-index-register.md\` | 飞书王语嫣域复核发现；#219同类问题 |
