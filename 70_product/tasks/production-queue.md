...
| 19 | `task_20260628_laowantong-link-repair-b2-synthesis-section` | B2：Synthesis section 死链/占位清理 | in_progress | 老顽童(WorkBuddy) | 235 + 66 遗漏 | 依赖 Batch 2-C reviewed | `60_feedback/tasks/task_20260628_laowantong-link-repair-b2-synthesis-section.md` | 欧阳锋终审驳回：235 张已处理，但扫描发现 66 个非 archive 卡片 Synthesis section 仍有 src_unknown（标题变体/段落占位遗漏）；清单见 `90_control/.tmp/b2_synthesis_src_unknown_remaining.json`；需补充清理 |
| 20 | `task_20260628_laowantong-link-repair-b3-island-cards` | B3：孤岛卡片 `kdo link-suggest` 批量推荐 | in_progress | 老顽童(WorkBuddy) | 1042 | 依赖 B2 修复完成 | `60_feedback/tasks/task_20260628_laowantong-link-repair-b3-island-cards.md` | 欧阳锋终审驳回：86.7% 孤岛减少达标，但发现 68 张仍全 pending 孤岛 + 1367 个 related 条目缺 `[[...]]` + 122 个单引号包裹 + 若干纯文本句子；pending_unknown.md 位置需移到 system/；清单见 `90_control/.tmp/b3_issues_summary.txt` |
| 21 | `task_20260628_laowantong-wave6-decision-science-systematization` | Wave 6-A：决策科学域系统化 | queued | 老顽童 | 5 | 依赖 Wave 6 诊断 reviewed | `60_feedback/tasks/task_20260628_laowantong-wave6-decision-science-systematization.md` | 老顽童负责；建 1 index + 2 framework + 1 dk + 1 case；决策科学域 reviewed 从 14→19 |
| 22 | `task_20260628_laowantong-wave6-demand-analysis-deepening` | Wave 6-B：需求分析域深化 | queued | 老顽童 | 5 | 依赖 Wave 6 诊断 reviewed | `60_feedback/tasks/task_20260628_laowantong-wave6-demand-analysis-deepening.md` | 老顽童负责；建 1 index + 2 case + 1 framework + 1 dk；需求分析域 reviewed 从 10→15 |
