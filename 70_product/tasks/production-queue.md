...
| 8 | `laowantong-batch-2026-06-20-wave4` | 老顽童批量工单第 4 波：新域建设 | claimed-hermes | Hermes 老顽童 | 15 | 已解锁（wave3 + 第八批均 reviewed） | `review_20260628_ouyangfeng-wave4.md` | Hermes 负责；4.2 Master 域 7 张卡已完成修复（pre-submit 全通过），4.1 调研方法论域 8 张卡生产中；欧阳锋审查任务单已创建 |
| 9 | `laowantong-batch-2026-06-20-wave5` | 老顽童批量工单第 5 波：新域建设 | queued | WorkBuddy 老顽童（预分配） | ~11 | 依赖 wave4 完成（wave4 由 Hermes 生产中） | `laowantong-batch-2026-06-20.md` | WorkBuddy 预分配；等 wave4 完成后开始生产；具体卡数见源文件 |
