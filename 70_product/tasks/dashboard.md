...
| laowantong-batch-2026-06-20 | 老顽童批量工单：全库待办一次性打包（5 波） | in_progress (wave2 reviewed, wave3 pending_review, 第八批 in progress, wave4 claimed, wave5 queued) | 老顽童 | P0-P2 | laowantong-batch-2026-06-20.md | wave2 16/16 欧阳锋子代理终审通过；wave3 已完成待欧阳锋终审（审查任务单 review_20260628_ouyangfeng-wave3.md）；第八批 dk 清零由 WorkBuddy 负责；wave4 由 Hermes 负责；wave5 由 Hermes 负责 |
...
| task_20260628_laowantong-case-section-standardization | 渠道增长域 10 张 case + 1 张 dk section 标准化 | pending_review | Kimi 老顽童 | P1 | task_20260628_laowantong-case-section-standardization.md | Kimi 实际完成；10 张 case + 1 张 dk section 已对齐；`kdo pre-submit` 8/8 通过；待欧阳锋抽检 |
...
- **Pending**: 1
- **Review Done**: 9 (panproduct-35, p0b-decision-science, p0a-unit-model, self-attack-framework, deliberate-practice-cards, wave1, wave2, channel-growth-cards, lanyi-panproduct-organization)
