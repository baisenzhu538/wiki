...
| task_20260628_laowantong-wave6-decision-science-systematization | Wave 6-A：决策科学域系统化 | queued | 老顽童 | P1 | task_20260628_laowantong-wave6-decision-science-systematization.md | 升级现有 `decision-science-domain-digest.md`（清理 src_unknown 占位）+ 新建 2 framework + 1 dk + 1 case；决策科学域 reviewed 从 14→18 |
