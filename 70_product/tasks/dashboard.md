...
| task_20260628_laowantong-lint-batch2-case-sections | lint Batch 2-A：case section 标准化补全 | claimed-laowantong | 老顽童 | P1 | task_20260628_laowantong-lint-batch2-case-sections.md | 老顽童重新领取：必须真实修改 130 个文件、`kdo lint` Case section ERROR 清零、跑 `git diff --stat` 验证 |
| task_20260628_laowantong-lint-batch2-dk-sections | lint Batch 2-B：dk section 标准化补全 | claimed-laowantong | 老顽童 | P1 | task_20260628_laowantong-lint-batch2-dk-sections.md | 老顽童重新领取：必须真实修改 43 个文件、`kdo lint` dk section ERROR 清零、跑 `git diff --stat` 验证 |
