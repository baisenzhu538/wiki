...
| task_20260628_laowantong-link-repair-b1-frontmatter-related | B1：frontmatter related 字段 src_unknown 占位清理 | claimed-laowantong | 老顽童 | P1 | task_20260628_laowantong-link-repair-b1-frontmatter-related.md | 老顽童已领取；自动写入 + 人工抽检 20 张；related 分层：concept/framework/dk/tool ≥5，case ≥3，draft ≥1 或 pending |
| task_20260628_laowantong-link-repair-b2-synthesis-section | B2：Synthesis section 死链/占位清理 | queued | 老顽童 | P1 | task_20260628_laowantong-link-repair-b2-synthesis-section.md | 必须人工审核逐张处理；Synthesis 出链 ≥2；批量提交 `--expect-changes` 门禁 |
