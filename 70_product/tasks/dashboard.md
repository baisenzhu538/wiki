...
| section-22-30-cards | 第二十二节 30 张卡深度精修 | A- 通过，返工 13 张 source 残留 | 老顽童 | P0 | section-22-laowantong-acceptance-2026-06-17.md |
| section-22-source-cleanup | 第二十二节：13 张卡 source_refs 残留清理 | pending | 老顽童 | P1 | section-22-laowantong-acceptance-2026-06-17.md |
| kf-021-cleanup-content-cards | KF-021 收尾：33 张 content 卡 source 缺失处理 | pending | 老顽童 | P1 | laowantong-next-tasks.md |
| kf-021-cleanup-meta-pages | KF-021 收尾：清理 index / log 元页面 source_refs | pending | 老顽童 | P2 | laowantong-next-tasks.md |
