...
| laowantong-batch-2026-06-20 | 老顽童批量工单：全库待办一次性打包（5 波） | in_progress (wave2 reviewed, wave3 reviewed, 第八批 pending_review, wave4 claimed, wave5 queued) | 老顽童 | P0-P2 | laowantong-batch-2026-06-20.md | wave2 16/16 欧阳锋子代理终审通过；wave3 14/14 欧阳锋终审通过；第八批 dk 清零由 WorkBuddy 负责，待欧阳锋抽检；wave4 由 Hermes 负责；wave5 由 Hermes 负责 |
...
| task_20260628_laowantong-dark-knowledges-batch8 | dark-knowledges 第八批清零：补齐 10 张问题 dk 卡 | pending_review | 老顽童（WorkBuddy） | P0 | task_20260628_laowantong-dark-knowledges-batch8.md | WorkBuddy 老顽童完成：10 张 dk 卡 pre-submit 全通过；dark-knowledges 目录 lint ERROR 归零；待欧阳锋抽检 |
...
- **Pending**: 1
- **Review Done**: 10 (panproduct-35, p0b-decision-science, p0a-unit-model, self-attack-framework, deliberate-practice-cards, wave1, wave2, channel-growth-cards, lanyi-panproduct-organization, wave3)
