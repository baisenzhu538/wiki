...
| task_20260628_wangyuyan-wave6-blindspot-diagnosis | Wave 6 新盲区探索诊断 | pending_review | 王语嫣 | P2 | task_20260628_wangyuyan-wave6-blindspot-diagnosis.md | 王语嫣已完成诊断：识别决策科学域系统化 + 需求分析域深化两个盲区；产出诊断报告；待欧阳锋审查 |
...
| task_20260628_laowantong-link-repair-b1-frontmatter-related | B1：frontmatter related 字段 src_unknown 占位清理 | pending_review | 老顽童(WorkBuddy) | P1 | task_20260628_laowantong-link-repair-b1-frontmatter-related.md | 老顽童已完成：256 文件 1947 src_unknown 清零 + 1190 pending_unknown 补入；`kdo lint` 0 ERROR；20/20 抽检通过；4/4 pre-submit PASS；待欧阳锋终审 |
| task_20260628_laowantong-link-repair-b2-synthesis-section | B2：Synthesis section 死链/占位清理 | claimed-laowantong | 老顽童(WorkBuddy) | P1 | task_20260628_laowantong-link-repair-b2-synthesis-section.md | 老顽童已按顺序领取；必须人工逐张审核；Synthesis 出链 ≥2；批量提交 `--expect-changes` 门禁 |
| task_20260628_laowantong-link-repair-b3-island-cards | B3：孤岛卡片 kdo link-suggest 批量推荐 | queued | 老顽童 | P2 | task_20260628_laowantong-link-repair-b3-island-cards.md | 半自动：kdo link-suggest 生成 + 人工审核写入；孤岛卡片减少 ≥80% |
| task_20260628_laowantong-wave6-decision-science-systematization | Wave 6-A：决策科学域系统化 | queued | 老顽童 | P1 | task_20260628_laowantong-wave6-decision-science-systematization.md | 建 1 index + 2 framework + 1 dk + 1 case；决策科学域 reviewed 从 14→19 |
| task_20260628_laowantong-wave6-demand-analysis-deepening | Wave 6-B：需求分析域深化 | queued | 老顽童 | P1 | task_20260628_laowantong-wave6-demand-analysis-deepening.md | 建 1 index + 2 case + 1 framework + 1 dk；需求分析域 reviewed 从 10→15 |
