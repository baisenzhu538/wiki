...
| task_20260628_laowantong-wave6-decision-science-systematization | Wave 6-A：决策科学域系统化 | claimed-hermes | 老顽童(Hermes) | P1 | task_20260628_laowantong-wave6-decision-science-systematization.md | Hermes 老顽童已领取；WorkBuddy 积分用完，后续 Wave 6 由 Hermes 承接；升级现有 digest + 新建 2 framework + 1 dk + 1 case |
| task_20260628_laowantong-wave6-demand-analysis-deepening | Wave 6-B：需求分析域深化 | claimed-hermes | 老顽童(Hermes) | P1 | task_20260628_laowantong-wave6-demand-analysis-deepening.md | Hermes 老顽童已领取；建 1 index + 2 case + 1 framework + 1 dk；需求分析域 reviewed 从 10→15 |
