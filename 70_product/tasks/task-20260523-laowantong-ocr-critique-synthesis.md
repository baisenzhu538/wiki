...
| 批次 | 来源 | 数量 | 优先级依据 |
|:--:|------|:--:|------|
| **Batch 1** | 洪七公高优先级清单 | ~5 张 | 视觉框架→洪七公先做 VA 分析，然后老顽童补 Critique+Synthesis |
...
**Batch 1 执行流程**：洪七公先对原图做 Visual Analysis 五维法 → 产出 VA 段落 → 老顽童基于 VA + OCR 文本走三步编译法的 Critique + Synthesis。
...
- **不要**对纯视觉卡（Batch 1）在洪七公完成 VA 前抢先编译
