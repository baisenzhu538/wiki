...
| 顺序 | 任务 | 状态 | 说明 |
|:----:|:-----|:----:|:------|
| **🔴** | **七件事集团 🟢/🟡 入库** | **✅** | **🟢 5 项已入库；🟡 4 项在实体页标为低信任待核实；🔴/⚫ 5 项未入库** |
| — | 断言式标题 | 持续 | 新卡强制执行 |
| — | 录音素材加工 | ⏳ | 等王语嫣下一批评估 |
...
- 王语嫣准入清单：`60_feedback/diagnosis/2026-06-13-kdo-admission-checklist.md`
- 药柜素材：`00_inbox/广冷电子/`

### 操作

1. 读准入清单，理解 🟢/🟡 分类
2. 读 `00_inbox/广冷电子/` 药柜素材
3. 🟢 内容先入库，🟡 标 `trust_level: low`，🔴 不入库
4. "宣称"数据标低信任，"矛盾"内容互相标 `contradicts`
