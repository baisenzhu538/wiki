// 通用 fs-doc 分段滚动提取：node tmp_extract_fsdoc.cjs <ns> <doc_id> <标题>
...
const TITLE = process.argv[4] || DOC_ID;
const OUT = `C:/Users/Administrator/Desktop/wiki/00_inbox/${TITLE}_v5.json`;
const TARGET_URL = `https://yitang.top/fs-doc/${NS}/${DOC_ID}?_uds=hyyy_biu`;
...
(async () => {
  ...
  if (loginWall) { console.log('NEED_LOGIN'); process.exit(2); }
  ...
  console.log('SCROLLABLES:', JSON.stringify(info.scrollables.slice(0, 6), null, 1));
