...
| Tool（工具） | 16 | +6 | `30_wiki/tools/tool-strategy-*` |
| Case（案例） | 12 | +6 | `30_wiki/cases/case-strategy-*` |
| **合计** | **36** | **+14** | — |
...
| tool-strategy-industry-chain-analysis | 产业链机会与行动计划分析工具 | _66 | 第 6 批 |
| tool-strategy-category-role-matrix | 零售品类角色矩阵 | _93 | 第 6 批 |
| tool-strategy-business-design-template | 业务单元业务设计模板 | _132 | 第 6 批 |
| tool-strategy-platform-business-map | 平台商业模式地图 | _263 | 第 6 批 |
...
| case-strategy-snack-industry-chain | 话梅果干产业链分析：从种植到零售的利润分布与竞争格局 | _67 | 第 6 批 |
...
| `_115` | 价值获取 8 问（业务模式/运营模式创新） | ✅ 已补充进 `tool-strategy-value-capture`（老顽童 2026-06-22：Purpose/Protocol/核心洞察/When NOT to Use/Critique） |
| `_184` | 物流费用节约三年计划模板 | ✅ `tool-strategy-logistics-cost-planning`（老顽童 2026-06-22） |
| `_249` | 各细分市场机会分析矩阵 | ✅ `tool-strategy-market-opportunity-matrix`（老顽童 2026-06-22） |
| `_269` | 深蓝海洋主题页 | ⏭️ 跳过，待后续确认内容 |
