...
C  MOTOR2_STATUS_PE4                                      3  PE4                        98     BOOT0    MOTOR2_PWM_PB9                                                                                                               5                       C
   ...
   REALY_R3_PC15                                          8  PC14-OSC32_IN    BOOT0     93              MOTOR_CTL_X_E_PB5                                                                                                               3
      ...
      REALY_R7_PC3                                       20  VREF-                PD1   81                    MOTOR_CTL_Y_A1_PD1                                       R19                                  U5                         C38 R18
                            ...
                            VDDA_3V3                     24  PA1                PC10    77                    FLASH_LED_PC10                                                                             2  RESET#  MR#  3
                            VDDA_3V3                     25  PA2                PA15    76
                                                         26  PA3                PA14    75     SWCLK_PA14
                    USART2_TX_PA2                        27  VSS_4            VDD_2     74   VDD_3V3                                           NRST
                    USART2_RX_PA3                        28  VDD_4            VSS_2     73
                                                   DGND  29  PA4                    NC  72    DGND                                                                                 R20
                                SW_PA4          VDD_3V3  30  PA5                PA13    71                                                                                         10K
                                SW_PA5                   31  PA6                PA12    70
                                SW_PA6                   32  PA7                PA11    69   SWDIO_PA13                                                                      DGND
                                SW_PA7                   33  PC4                PA10    68                MOTOR_SW1_PA12
                             ADC2_PC4                    34  PC5                  PA9   67                MOTOR_SW2_PA11                                                                                                                         VDD_3V3
                             ADC1_PC5                    35  PB0                  PA8   66                MOTOR_SW3_PA10
   MOTOR_CURRENT_ADC_PB0                                 36  PB1                  PC9   65                MOTOR_SW4_PA9
           INFRARED_PW_EN_PB1                            37  PB2                  PC8   64                MOTOR_SW5_PA8
                                                         38  PE7                  PC7   63                MOTOR_SW6_PC9
                          PNP2_PE8                       39  PE8                  PC6   62                MOTOR_SW7_PC8                                                                                                  X1          C39    C40  C41
                          PNP1_PE9                       40  PE9                PD15    61                MOTOR_SW8_PC7                                                                                     4 VCC ST# 1
                                                         41  PE10               PD14    60                MOTOR_DETECT_Y8_PC6                                                                               3 OUT GND 2              1nF    100nF 100nF
   SIG2_INFRA_DETECT_PE10                                42  PE11               PD13    59                MOTOR_DETECT_Y7_PD15
   SIG1_INFRA_DETECT_PE11                                43  PE12               PD12    58                MOTOR_DETECT_Y6_PD14                              FCLK_8MHZ  R21         33                                  8MHz
                                                         44  PE13               PD11    57                MOTOR_DETECT_Y5_PD13
                        NPN2_PE12                        45  PE14               PD10    56                MOTOR_DETECT_Y4_PD12                                                                                                  DGND
                        NPN1_PE13                        46  PE15                 PD9   55                MOTOR_DETECT_Y3_PD11
             SW1_DETECT_PE14                       DGND  47  PB10                 PD8   54                MOTOR_DETECT_Y2_PD10
                                                VDD_3V3  48  PB11               PB15    53                MOTOR_DETECT_Y1_PD9
             SW2_DETECT_PE15                             49  VSS_1              PB14    52
                                                         50  VDD_1              PB13    51                SW6_DETECT_PD8
              USART3_TX_PB10                                                    PB12                      SW5_DETECT_PB15
              USART3_RX_PB11                                                                              SW4_DETECT_PB14
                                                                                                          SW3_DETECT_PB13
...
A                                                     74HC237D,653                            3  3B        3C  14      MOTOR_X3                                                             A
                  ...
                  MOTOR_CTL_X_A2_PD5               3  A2        Y2  13                        7  7B        7C  10      MOTOR_X7
                                                                                              8  E      COM    9
                  MOTOR_CTL_X_LE_PD6                                                                                         MOTOR_VDD_24V
                    MOTOR_CTL_X_E_PB5                           Y3  12
                                                   4  LE#       Y4  11                           C51 100nF
                  MOTOR_CTL_X_EN_PD7               5  E1#       Y5  10
                                                   6  E2        Y6  9
                                                                Y7  7
                                                                                              DGND
...
B                                                          74HC237D,653                       5  5B         5C  12     MOTOR_X12                                                            B
   ...
   MOTOR_CTL_X_A1_PD4                              2                14                        8  E       COM    9
   MOTOR_CTL_X_A2_PD5                              3                13                                                    MOTOR_VDD_24V
                                                      A1        Y1  12
   MOTOR_CTL_X_LE_PD6                                 A2        Y2  11
                                                                Y3  10
   MOTOR_CTL_X_EN_PD7                              4            Y4                                  C53 100nF
                                                   5            Y5
                                       MOTOR_X_E1     LE#
                                                      E1#
                                                   6 E2             9                         DGND
...
C                                                         U12            C55                                                                                                                C
                 ...
                 MOTOR_CTL_Y_A1_PD1
                 MOTOR_CTL_Y_A2_PD0                1 A0        Y0# 15
                                                   2                14                        DGND
                 MOTOR_CTL_Y_EN_PC11               3  A1       Y1#  13
                                                      A2       Y2#  12                                  U13
                                                               Y3#  11
                                                   6           Y4#  10                                  ULN2003AIDR
                                                   5           Y5#
                                                      E1#                                        1  1B         1C  16  MOTOR_Y2
                                                      E2            9                            2  2B         2C  15  MOTOR_Y3
                                                                    7                            3  3B         3C  14  MOTOR_Y4
                                                   8 GND       Y6#                               4  4B         4C  13  MOTOR_Y5
                                                               Y7#                               5  5B         5C  12  MOTOR_Y6
                                                                                                 6  6B         6C  11  MOTOR_Y7
...
B  A3963WV-7P                                                                                                                                                                                                                     B
       ...
       77            SW6_DETECT_IN                                                                    C66 C67 C68 C69 C70 C71
               6     SW5_DETECT_IN
       ...
       1              DGND
                                                                                                      ...
                                                                                                      C73 100nFY1                                  U17                                       MOTOR_DETECT_Y1_PD9
                                                                                                      C74 100nFY2                                  ULN2003AIDR                               MOTOR_DETECT_Y2_PD10
                                                                                                      C75 100nFY3                                                                            MOTOR_DETECT_Y3_PD11
                                                                                                      C76 100nFY4                        1  1B        1C  16                                 MOTOR_DETECT_Y4_PD12
                                                                                                      C77 100nFY5                        2  2B        2C  15                                 MOTOR_DETECT_Y5_PD13
                                                                                                      C78 100nFY6                        3  3B        3C  14                                 MOTOR_DETECT_Y6_PD14
                                                                                                      C79 100nFY7                        4  4B        4C  13                                 MOTOR_DETECT_Y7_PD15
                                                                                                      C80 100nFY8                        5  5B        5C  12                                 MOTOR_DETECT_Y8_PC6
                                                                                                                                         6  6B        6C  11
C                                                                                                                                   RN9  7  7B        7C  10  VDD_3V3             RN10                                            C
                                                                                                                                    10K  8  E      COM    9                        1K
   ...
   VDD_24V                                                                                      C82 100nF SW8                            1  1B        1C  16                      RN14       MOTOR_SW8_PC7
                                                                                                C83 100nF SW7                            2  2B        2C  15                        1K
   PNP2_24V                1  1                                                                 C84 100nF SW6                            3  3B        3C  14                                 MOTOR_SW7_PC8
   PNP1_24V                2  2                                                                 C85 100nF SW5                            4  4B        4C  13                                 MOTOR_SW6_PC9
   PNP_IR                  3  3                                                                 C86 100nF SW4                            5  5B        5C  12                                 MOTOR_SW5_PA8
   NPN_IR                  4  4                                                                 C87 100nF SW3                            6  6B        6C  11                                 MOTOR_SW4_PA9
   NPN2_24V                5  5                                                                 C88 100nF SW2                            7  7B        7C  10                                 MOTOR_SW3_PA10
   NPN1_24V                6  6                                                                 C89 100nF SW1                            8  E      COM    9                                  MOTOR_SW2_PA11
                           7  7                                                                                                                                                              MOTOR_SW1_PA12
                           8  8
                                                                                                                  RN13                                        VDD_3V3
                                                                                                                   10K
...
C            R124     0           3  ALERT  VREF      14  M1_PWM                            2             1                  R125  0         3  ALERT  VREF      14  M2_PWM                                2            1                C
                      M1_IN1      4  OSC     PWM      13  M1_OUT2                                                                  M2_IN1    4  OSC     PWM      13  M2_OUT2
                                  0  IN1    TISD      0                                        F3 JK30-110                                   0  IN1    TISD      0                                              F4 JK30-110
