...
#define IAP_BOOTLOAD_SIZE     ((uint32_t)(6*1024))             //bootload所占空间,6KB
...
#define IAP_DATABASE_FLASHADDR (IAP_USER_ADDR+IAP_USER_FLASHSIZE+IAP_USER_FLASHSIZE)
#define IAP_DATABASE_FLASHSIZE (STM32_FLASH_SIZE-IAP_BOOTLOAD_SIZE-IAP_USER_FLASHSIZE-IAP_USER_FLASHSIZE)
