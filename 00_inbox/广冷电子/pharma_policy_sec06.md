...
各省对远程审方中心执业药师的配备要求差异显著，主要体现在基数门店数量和增量配比两个维度。云南以10家门店配3名执业药师、每增15家增1名，1名执业药师理论上可覆盖约5家门店，配比最为宽松；福建要求20家门店基数3名、每增10家增1名；北京、重庆采用30家基数3名、每增10家增1名的标准，介于宽松与严格之间 [^dim05-3]。山西省2026年新规未按门店比例硬性规定，仅要求远程药学服务部原则上不少于2名执业药师，具体数量与服务范围和规模匹配，赋予企业灵活性但也增加了合规不确定性 [^shanxi-1]。
...
*数据来源：各省药监局公开文件及政策解读 [^dim05-3] [^yunnan-1] [^fujian-1] [^beijing-1] [^shanxi-1] [^hunan-1] [^shaanxi-1] [^heilongjiang-1] [^chongqing-1] [^liaoning-1] [^shanghai-1]。*
