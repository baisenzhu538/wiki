...
rem #690: DEST via kdo_memory_root marker scan (guard 2: no hardcoded driftable drive
rem letter; guard 1: missing disk -> resolver writes gate-blocked alarm, fail visibly)
"C:\Program Files\Python312\python.exe" "C:\Users\Administrator\Desktop\wiki\kdo-tools\kdo_memory_root.py" > "%TEMP%\kdo_mem_root.txt"
set /p DEST=<"%TEMP%\kdo_mem_root.txt"
del /q "%TEMP%\kdo_mem_root.txt" >nul 2>&1
