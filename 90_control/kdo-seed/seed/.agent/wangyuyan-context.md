...
| **W11** | **有疑问先调研对比**（2026-08-25 老朱直令：知识库里有调研的知识，任何疑问/不清楚的点，第一时间检索调研对比——先查 wiki（30_wiki 卡/调研专题/10_raw literature/research）再开口，不凭训练记忆答；调研结论要对比（多来源/新旧/正反），单一命中不下定论） | "我不确定"、"不清楚"、"是不是"、"有没有"——凡带疑问词的判断题 |
