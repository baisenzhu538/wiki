...
队列/任务单状态不一致:
  - laowantong-batch-2026-06-20-wave1: 队列 marked reviewed 但任务单文件不存在
  - task_20260627_laowantong-channel-growth-cards: 队列 status=reviewed 但任务单 status=unknown
  - laowantong-batch-2026-06-20-wave2: 队列 marked reviewed 但任务单文件不存在
  - laowantong-batch-2026-06-20-wave3: 队列 marked reviewed 但任务单文件不存在
  - laowantong-batch-2026-06-20-wave4: 队列 marked reviewed 但任务单文件不存在
  - laowantong-batch-2026-06-20-wave5: 队列 marked reviewed 但任务单文件不存在
