...
对 19 张 P1 卡统一采取 **"补 source_refs + 保持 draft"** 的最小化修复：

| 主题 | 卡片数 | 补录来源 |
|:---|:---:|:---|
| 张磊·精益测试案例 | 3 | `zhanglei-lean-testing-oral-01.md` + `zhanglei-lean-testing-notes-01.md` |
| 张磊·精益方法论概念/框架 | 9 | `src_20260614_606a631d-张磊-精益方法论培训.md` |
| 徐剑·ToB 五步法概念/框架 | 6 | `xujian-tob-fivestep-oral.md` + `xujian-tob-fivestep-notes.md` |
| 知识库错误自暴露 | 1 | `src_20260611_4c587435-一堂-一堂五步法-需求-AI企业知识库-产品路线图_paddle_ocr.md` |

> 这些卡仍保持 `status: draft`，未进行格式精修升 enriched；本次仅消除因 source_refs 为空产生的 P1。

### 最终门禁

```
total=1200, p0=0, p1=0, clean=1200, yaml_error=0
```
...
✅ **全库 P0=0，P1=0，YAML 错误=0，clean=1200。**  
✅ **可进入下一节任务。**
