...
### D-1. 调研方法论 artifact 角度 — 已关闭

**状态：** 已关闭（2026-05-03）
**决策者：** 用户
**方向：** 面向创业者的实操指南，偏 how-to，核心主张是"用 OSCAR 五步法快速验证创业假设"

**写作指令：**
| 维度 | 要求 |
|------|------|
| 目标读者 | 创业者（没时间读理论，要马上能用） |
| 核心信息 | 每次启动新方向前，用 5 天而不是 5 个月搞清楚该不该做 |
| 写作风格 | 偏实操/步骤化，少讲概念多讲怎么做 |
| 篇幅 | 1500-3000 字 |
| 标题方向 | "用 OSCAR 五步法，一周内验证你的创业假设"（可调整） |
...
|:----:|------|---------------|-------------|:--------:|
| 1 | **enrich CJK 能力建设** | 手工先跑，量级驱动方案选择 | 同样是卡点，未倾向具体方案 | **已关闭: 智能体替代** ✅ |
| 2 | **调研方法论 artifact 角度** | — | 需要你定角度方向 | **已关闭: 创业者实操指南** ✅ |
| 3 | **txt→md 静默失败** | 应改 ingest 为发出警告 | 描述了问题，未提方案 | 待你定 |
| 4 | **produce 完成标准** | draft 非空才算完成 | 同意 | — |

第 4 项已共识可直接执行。第 3 项待你定。
