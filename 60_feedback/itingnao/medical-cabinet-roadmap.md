...
B 阶段三项任务：
1. ✅ 生成医疗短视频合规卡 → `concept-medical-shortvideo-compliance-for-clinics.md`
2. ✅ 复核 12 条被污染录音 → `medical-cabinet-contaminated-recordings-review.md`
3. ✅ 建立线下调研任务清单 → `medical-cabinet-field-validation-checklist.md`

当前药柜主题长程整理共生成：
- **17 张基础卡**
- **2 份管理文件**：路线图 + 质量控制清单
- **2 份辅助文件**：被污染录音复核报告 + 线下调研任务清单
...
C 阶段三项任务：
1. ✅ 生成支付合规卡 → `concept-medical-cabinet-payment-settlement.md`
2. ✅ 生成医疗系统/HIS 卡 → `concept-medical-cabinet-his-system.md`
3. ✅ 复核 3 条待定录音 → 已更新 `medical-cabinet-contaminated-recordings-review.md`
   - 4231073：高度疑似药柜/自动售药设备，待原文最终确认
   - 6272697、6311449：不移入整条录音，仅相关片段归档；已将 6272697 温控片段补充至硬件技术卡
...
1. **启动 P0 线下调研**：至少完成单设备真实运营数据、医保支付口径、设备成本验证中的一项。
2. **处理剩余被污染录音**：
   - 4226418 药店选址选品运营
   - 4092592 药店数字化改造
   - 2694971 药店 AI 应用
   - 1486162 智慧城市医疗 AI
   - 3166977、2247045 品牌/供应链
3. **复核 4231073 原始录音**，确认是否为药柜设备。
4. **将高可信度卡片迁移至 `30_wiki/`**：建议先由老顽童审核后统一迁移。
5. **建立定期复核机制**：建议每 3 个月复核一次药柜主题卡片。
