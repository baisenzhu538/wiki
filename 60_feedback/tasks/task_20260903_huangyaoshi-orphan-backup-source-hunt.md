...
- ? **?????????**?`.obsidian/plugins/obsidian-git/data.json` ?? `autoSaveInterval=10`?`autoCommitMessage`= `commitMessage` = `vault backup: {{date}}`?`disablePush=False`??? vault_git_backup.py ???????`git log --grep='^vault backup:'` ?? 01:28:02?01:38:12??? 545bd0f5a??01:48:24?01:58:34 ?? ~10min ???? commit ??????? :20/:50 ???00:20:00/00:50:00/01:20:00?= schtasks ????????????
- ? **????**?`conveyor_probe.py` ????? `_scan_offbeat_backup`?`_OFFBEAT_GRID_MINUTES=(20,50)`?3h ???10min ??????????????????+ ???? `_scan_backup_stall` ? `_last_skip_age_h()` ???SKIPPED ???=???????SKIPPED ???????????????????????????????? :02/:32 ?????:20/:50 ??????
- ? **??????**?`test_backup_signals_631.py` 6 passed????? `kdo-tools/tests + 90_control/scripts` **488 passed / 0 failed**???????????
- ? **??????**??????conveyor_probe.py / test_backup_signals_631.py / notification-coverage-matrix.md ? 28 / ?????????? HEAD?dba59a8cf??`git status` ???????
- ? **???????**????/????/??/??/????? ??????????#607 ???? cron ???????????????+???????
- ?? **??????????**?? obsidian-git auto backup ???????????? latch ???????????? obsidian-git ??????? push ???autoPushInterval=10 + disablePush=False???? auto backup ?? push ???????=?????????????????/???????? ??? :20/:50 ??????schtasks ????????????=????????? ??????????????=??????????production-queue ??????

**????**??? ? ????????????? obsidian-git ????????????????????????????????????/??? auto backup ?????????? .obsidian?????????????????????
**?????**???????? = `git log --grep='^vault backup:' --since='2026-09-03 00:00' --until='2026-09-03 02:30'` + `.obsidian/plugins/obsidian-git/data.json` ?? + `git show 545bd0f5a --stat`?????? commit 545bd0f5a?01:38:12?? ~10min ??????obsidian-git ???????????????????#607 ???? cron ??????????+?????????????????
