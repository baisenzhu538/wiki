...
- 需要秒级决策的紧急场景中不要用——泛产品设计·落地卡片：解放思想的完整流程耗时较长，紧急场景需要更轻量的判断。
- 资源极度受限时不要追求泛产品设计·落地卡片：解放思想的完整流程——做20%的核心步骤比做100%的敷衍步骤更有价值。
- 在问题边界尚不清晰时不要使用——泛产品设计·落地卡片：解放思想需要明确的目标和约束才能有效。先做探索性分析再回来。
