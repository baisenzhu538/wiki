...
| 模式 | 症状 | 修复 |
|:-----|:------|:-----|
| **"把Y模型当万能框架"** | 什么决策都走一遍，团队对工具疲劳 | 设定决策阈值：投入<1万或影响<3人直接凭直觉；创意决策用品味仲裁者 |
| **"框架成为权力挡箭牌"** | "我们用Y模型分析过了"成为不容质疑的挡箭牌 | 明确规则：Y模型是讨论工具，任何人都可以挑战前提假设和关键参数 |
| **"找全幻觉"** | 列完清单就认为覆盖了所有风险 | 主动寻找"未知未知"：找 1-2 个该领域老兵补充盲区，或用"反向检查"问"哪些项一定不会发生" |
| **"定量迷信"** | 把L3/L4估计当作精确事实 | 每个数字标注置信度（高/中/低）和数据来源，敏感性分析识别关键参数 |
