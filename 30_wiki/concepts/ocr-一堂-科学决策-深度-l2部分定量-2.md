...
原图: `一堂-科学决策-深度-L2部分定量.

*` 单元模型ROI深度：L2部分定量 A B X 定量 定钱 - 本文件由 PaddleOCR ONNX pipeline 自动提取 - 可能存在连字/误识，需要人工校对 - 视觉结构信息（标题/正文/表格分块）未在 OCR 中体现，需要结合原图理解

## Source Refs

- `src_20260609_b791433c` -> `10_raw/sources/src_20260609_b791433c-ocr-一堂-科学决策-深度-l2部分定量.md`
