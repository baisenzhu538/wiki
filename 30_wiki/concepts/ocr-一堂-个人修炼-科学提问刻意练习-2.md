...
type: "concept"
status: "enriched"
source_refs: [src_20260609_e13d29d9]
...
*` 辅导 咨询 业务分析 团队 萃取经验 Analysis 教练 Teaching Socrates Coaching 科学提问·刻意练习成长地图 堂内部使用·谢绝传播 - 本文件由 PaddleOCR ONNX pipeline 自动提取 - 可能存在连字/误识，需要人工校对 - 视觉结构信息（标题/正文/表格分块）未在 OCR 中体现，需要结合原图理解

## Source Refs

- `src_20260609_e13d29d9` -> `10_raw/sources/src_20260609_e13d29d9-ocr-一堂-个人修炼-科学提问刻意练习.md`
