...
| 模式 | 症状 | 修复 |
|:-----|:------|:------|
| **"精美的幻觉"** | AI输出结构完美、数据准确但关键前提不成立 | 执行"10%幻觉检查"：要求AI列出分析中3个最大假设漏洞 |
| **"盲区的盲区"** | AI不会说"不知道"，而是补一个看似合理的维度 | 要求AI明确标注每个断言的置信度，标注"低"的必须人工复核 |
| **"确认偏误放大器"** | 用户的倾向性提问让AI成为"更好的拍马屁工具" | 强制使用"反对者角色"——先让AI反驳，再让AI支持 |
| **"模板化决策"** | AI生成了标准化的分析矩阵，但忽略了场景的特殊性 | 在提示词中明确："这是一个XX行业的小团队创业场景，不是大公司标准化决策" |
