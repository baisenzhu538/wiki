...
| 边界 | 说明 |
|------|------|
| **适合** | 需要快速突破行业信息壁垒、获取一手共识 |
| **适合** | 已有明确假设，需要通过专家验证或补充 |
| **不适合** | 问题过于宽泛、连要问什么都不知道 |
| **不适合** | 可以找到更便宜、更快的二手数据源 |

### 失败模式

1. **找错专家，得到的建议不适用**
   - **原因**：专家匹配失败
   - **修复**：访谈前明确需要的经验类型：行业、职能、阶段、规模

2. **问题设计得太开放，访谈变成闲聊**
   - **原因**：缺少结构
   - **修复**：使用结构化提纲：背景→核心问题→假设验证→案例追问

3. **只问支持自己假设的问题**
   - **原因**：确认偏误
   - **修复**：强制加入‘什么情况下我的假设是错的’这样的问题

4. **访谈完不做整理，信息散落在笔记里**
   - **原因**：缺少闭环
   - **修复**：24小时内输出访谈摘要：关键洞察、待验证点、行动项
