...
| 边界 | 说明 |
|:-----|:------|
| ✅ 适合条件 | 需要获取行业一手认知、公开信息不足以支撑决策、有明确的'待验证假设'而非泛泛了解需求、有至少2位以上可访谈的目标专家 |
| ❌ 不适合条件 | 行业公开信息充分且可替代（先读报告再决定是否访谈）、没有明确假设（泛泛了解不如读书）、专家有明显的利益冲突（如投资了竞品） |

### 常见失败模式

| 模式 | 症状 | 修复 |
|:-----|:------|:------|
| **访谈了但没收获——缺少可验证断言** | 访谈结束后，发现专家说的都是行业共识级信息（市场增速、竞争格局），没有产出任何能指导决策的独家洞察。用户感觉'访谈了个寂寞'。 | 访谈准备阶段强制输出'待验证断言'：写3-5个'我认为可能是真的，但不确定'的断言。每次访谈的目标是验证或证伪这些断言——不是'听专家讲课'。 |
| **权力关系扭曲信息** | 专家根据你的身份（投资人/学生/竞品）策略性地选择说什么、不说什么。你听到的不是真相，而是专家'想让你听到的'。 | 在访谈中设计'反向验证'问题：同一个问题从不同角度问两次，对比答案的一致性。同时记录专家'不愿意说什么'——回避的问题往往比回答的问题更有信息量。 |
