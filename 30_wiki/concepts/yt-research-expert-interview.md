...
- claim:boundary-01 [conf=0.85] **专家的"选择偏差"风险**：你能找到的专家往往是你已经能接触到的——同行朋友介绍、领英上看得到的。这类专家的观点可能和你已有认知高度重叠，难以突破信息瓶颈。真正有价值的可能是"你找不到的人"。
- claim:boundary-02 [conf=0.80] **"行业共识"的滥用**："行业共识"不等于"正确"。很多行业共识是过时的、错误的、或者被制造出来的。如果将专家访谈的结论当作"终端真理"而不做交叉验证，可能被带偏。
- claim:boundary-03 [conf=0.80] **访谈的"社会工程学"比重不均**：这个工具包强调"标准流程"，但在中国商业环境中，专家是否愿意说真话很大程度上取决于你和他的关系、你的身份、你能提供的交换价值。流程是必要的，但不是充分的。
