...
| 边界 | 说明 |
|:-----|:------|
| ✅ 阅读目标是解决具体问题或升级某个认知 | 十步框架是工具，不是阅读仪式 |
| ✅ 愿意投入时间做深度阅读和反思 |  shallow reading 不需要十步 |
| ✅ 能将书中的认知转化为最小行动 | 没有行动就没有补丁安装 |
| ❌ casual reading 或娱乐阅读 | 十步框架太重 |
| ❌ 追求阅读数量而非质量 | 十步框架会降低阅读速度 |
| ❌ 不愿意做行动实验 | 框架的核心是行动转化 |
...
| 模式 | 症状 | 修复 |
|:-----|:------|:-----|
| **"为笔记而读"** | 笔记精美但无行动 | 十步中必须产出"最小行动"和"三周后复诊" |
| **"每本书都十步"** | 对所有书用完整流程 | 根据书的重要性选择深度，轻书用3步，重书用10步 |
| **"补丁装太多"** | 同时实践多个新认知，互相冲突 | 同一时期只安装1-2个认知补丁 |
| **"不复诊"** | 安装后不再回顾效果 | 设置三周复诊提醒，评估补丁是否生效 |
## Synthesis
