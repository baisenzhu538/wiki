...
| skill-ai-four-elements-validation | 技能：真需求四要素验证法 | tool | ai-collaboration, yitang |
| skill-ai-info-literacy-three-layer | 技能：AI输出三层防护检查法 | tool | ai-collaboration, yitang |
...
| skill-ai-problem-question-check | 技能：Problem vs Question 区分法 | tool | ai-collaboration, yitang |
...
| skill-纪浩-AI使用边界管理法 | 技能：AI使用边界管理法 | tool | ai-collaboration, yitang |
...
| skill-纪浩-AI工具脚本化约束 | 技能：AI工具脚本化约束 | tool | ai-collaboration, yitang |
| skill-纪浩-Agent开工检查单制作法 | 技能：Agent开工检查单制作法 | tool | ai-collaboration, yitang |
...
| skill-纪浩-Problem与Question区分法 | 技能：Problem与Question区分法（纪浩版） | tool | ai-collaboration, yitang |
| skill-纪浩-problem-validation-four-checks | 技能：四问验证法 —— 判断需求是真实Problem还是伪需求 | tool | ai-collaboration, yitang |
| skill-纪浩-任务交付物标准化 | 技能：任务交付物标准化 | tool | ai-collaboration, yitang |
| skill-纪浩-低成本输出验证法 | 技能：低成本输出验证法 | tool | ai-collaboration, yitang |
| skill-纪浩-处理AI生成代码运行异常 | 技能：处理AI生成代码运行异常 | tool | ai-collaboration, yitang |
...
| voice-input-doubao | voice input doubao | tool | product, ai-saas, decision-making, yitang |
...
| yitang-qualitative-to-quantitative | 一堂·从定性到定量：先证伪、后测量 | concept | yitang, entrepreneurship, business-strategy |
| yitang-strategy-canvas | 战略画布（Strategy Canvas）：把竞争格局画成一张价值曲线 | tool | yitang |
...
| yt-management-company-culture | 公司文化 | concept | management, business-strategy, ai-saas, design, yitang |
| yt-management-conversion-hacking | 转化率黑客 | concept | management, product, business-strategy, ai-saas, yitang, decision-making |
| yt-management-finance-basics | 财务入门 | concept | management, business-strategy, finance-legal, ai-saas, yitang |
| yt-management-founder-role | 一号位 | concept | ai-saas, management, yitang |
| yt-management-goal-management | 目标管理 | concept | ai-saas, management, yitang |
| yt-management-leadership-levels | 管理段位 | concept | ai-saas, management, kdo, yitang |
| yt-management-onboarding | 新人落地 | concept | management, product, ai-saas, design, yitang |
| yt-management-partnership-equity | 合伙股权 | concept | yitang |
| yt-management-project-management | 项目管理 | concept | product, ai-saas, management, yitang |
| yt-management-scientific-decision | Y模型/科学决策 | concept | ai-saas, management, decision-making, yitang |
| yt-management-scientific-hiring | 科学招聘 | concept | management, product, ai-saas, design, yitang |
| yt-management-scientific-meetings | 科学开会 | concept | ai-saas, management, yitang |
| yt-management-strategy-meeting | 战略会 | concept | ai-saas, management, decision-making, yitang |
| yt-management-team-knowledge | 团队知识管理 | concept | management, product, ai-saas, yitang, kdo |
...
| yt-note-deliberate-practice-four-elements | 四要素诊断模型——刻意练习的笔记落地框架 | concept | yitang |
...
| yt-personal-ai-thinking-card | AI思维卡：从「读书」到「安装认知补丁」 | tool | personal-methods |
...
| yt-prompt-engineering-andrew-ng | 吴恩达提示词课程·一堂拆书精华 | report | yitang, ai |
...
| yt-research-mindset | 调研认知升级：从"找答案"到"拆解假设" | concept | yitang |
| yt-research-osl-framework | OSL调研五步法：一堂通用商业调研框架 | framework | yitang |
| yt-research-user-jtbd | 用户JTBD访谈工具：区分"说的"和"真正要的" | tool | yitang |
...
| yt-tob-cash-flow | To B 现金流管理：自由现金流比账面利润更重要 | concept | yitang, entrepreneurship, b2b, business-strategy |
| yt-tob-revenue-is-customer-cost | To B 收入本质 = 客户成本 | concept | yitang, entrepreneurship, b2b, business-strategy |
| yt-tob-sales-unit-model | To B 单销售模型：时间闭环 + 空间闭环 | concept | yitang, entrepreneurship, b2b, business-strategy |
...
| yt-lean-consumer-deep-experience-testing | 消费品深层体验测试：表层反馈 vs 深层体验 | framework | yitang, entrepreneurship, business-strategy |
...
| yt-tob-demand-metrics | To B 需求测算双指标：成本占有率 + 业务天花板 | framework | yitang, entrepreneurship, b2b, business-strategy |
| yt-tob-demand-scenarios | To B 需求场景四象限 | framework | yitang, entrepreneurship, b2b, business-strategy |
| yt-tob-growth-channel | To B 增长模式取舍：直销 vs 渠道 | framework | yitang, entrepreneurship, b2b, business-strategy |
| yt-tob-product-kernel | To B 产品内核：面向决策者研究付费，面向使用者夯实价值 | framework | yitang, entrepreneurship, b2b, business-strategy |
| yt-tob-solution-model | To B 解决方案类型矩阵 | framework | yitang, entrepreneurship, b2b, business-strategy |
| yt-tob-unit-model | To B 单元模型选择与跑通 | framework | yitang, entrepreneurship, b2b, business-strategy |
| yt-unit-model-ladder | 单元模型六段进阶：从拍脑袋到动态预测 | framework | decision-science |
| yt-unit-model-overview | 单元模型概览：十大单元模型与三角色分工 | framework | decision-science, yitang, entrepreneurship |
...
| mineru-pdf-parsing-setup | MinerU (magic-pdf) PDF 解析工具安装与使用 | tool | kdo, infrastructure |
...
| tool-ai-skill-engineering-guide | 高阶 AI Skill 工程指南：用 AI 辅助封装高质量 Skill 的工作流 | tool | yitang, ai, modeling |
...
| case-modeling-abstraction-yitang-models | 抽象建模案例：一堂内部模型武器库与跨领域商业模型地图 | case | yitang, master, modeling |
| case-modeling-essence-levels | 本质建模案例：从盲目创新到学科经典的五层思维深度 | case | yitang, master, modeling |
| case-modeling-essence-schools | 本质建模案例：知识付费派、经验萃取派与学科建模派的三派分野 | case | yitang, master, modeling |
| case-modeling-process-livestream-prep | 流程建模案例：Truman 直播开播前 2 小时个人准备清单 | case | yitang, master, modeling |
| case-modeling-process-livestream-roles | 流程建模案例：直播开播团队分工与检查清单 | case | yitang, master, modeling |
| case-modeling-process-sop-evolution | 流程建模案例：一堂 2021-2024 年 SOP 清单演进史 | case | yitang, master, modeling |
...
| dk-ef-004-missing-diagnostic-firmware | 没有诊断固件就是盲调：你不知道信号卡在哪一级 | dark-knowledge | product |
...
| dk-modeling-ai-compound-leverage | AI 加杠杆最大的场景是建模，因为好模型会被反复调用 | dark-knowledge | yitang, ai-saas |
...
| dk-modeling-business-visual-logic-match | 交互设计的精髓不是好看，是业务逻辑和视觉逻辑高度匹配 | dark-knowledge | yitang, ai-saas |
| dk-modeling-case-explosion-confidence | 案例大爆炸的底气：来自销冠广场，不是胆子大 | dark-knowledge | yitang, modeling |
| dk-modeling-checklist-formatting-rules | 清单体写不好，模型就建不好：换行、分层、优先级、完备 | dark-knowledge | yitang, ai-saas |
| dk-modeling-counterexample-driven | 建模不是找证据证明自己是对的，而是用反例把自己逼到没漏洞为止 | dark-knowledge | yitang, master |
| dk-modeling-course-rnd-ripe-fruit | 研究型课程无法提前排课表：只能等菜熟了再摘 | dark-knowledge | yitang, ai-saas |
...
| dk-modeling-logical-cleanliness-root | 逻辑洁癖是建模之本：不是天赋，而是不能容忍低水平逻辑 | dark-knowledge | yitang, ai-saas |
| dk-modeling-model-arsenal-paradigms | 99% 的模型跑不出二三十个范式：先装武器库再创新 | dark-knowledge | yitang, ai-saas |
| dk-modeling-question-scaffold-not-answer | 模型是提问的脚手架，不是答案 | dark-knowledge | yitang, modeling, business-strategy |
| dk-modeling-radar-model-not-result | 复杂评选别让 CEO 拍结果，只让 CEO 审模型 | dark-knowledge | yitang, ai-saas |
...
| dk-modeling-unit-pairs-milestone | 里程碑不是任务清单，是"成对单元模型"拼出来的 | dark-knowledge | yitang, ai-saas |
...
| dk-p15-unverified | dk p15 unverified | dark-knowledge | product |
...
| 七件事集团 | 七件事集团 | entity | 私域电商, SaaS, 分销系统 |
