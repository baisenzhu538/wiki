...
| 案例 | 来源 | 失败表现 | 根因 | 修复 |
|---|---|---|---|---|
| **一堂直播前 SOP 1.0 → 3.0 迭代** | `src_20260614_42f1e977-一堂-建模能力培训-truman-笔记.md:58` + `src_20260614_623cfbfd-高阶建模-流程建模.md:7` | 早期直播状态不稳定，饮食、休息、设备等问题反复出现 | V1 只有执行清单，靠自觉；执行率 50-70% | 升级到 V2 增加督导 SOP，V3 增加品控 SOP，最终执行率接近 100% |
| **孩子控笔训练口诀反例** | `src_20260614_42f1e977-一堂-建模能力培训-truman-笔记.md:57` | 若口诀只有"找开头、控比例"而无"随时改、画曲线"，孩子会机械执行、遇到曲线就失败 | 清单未覆盖所有关键动作 | 按 MECE 补全四个关键动作，形成完整口诀 |
