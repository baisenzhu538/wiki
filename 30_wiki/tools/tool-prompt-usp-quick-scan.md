...
```
- 业务核心定位：面向通信运营商/代维外包商，解决临时装维兼职人员结算合规与效率问题的ToB服务
- 三维拆解清单：
...
- 深度不足——缺少 JTBD 任务拆解和四种力量分析
- 对复杂场景（多用户角色/多场景交叉）输出可能过于简化
- 不含行业字典——在陌生领域可能给出泛泛的结果
- 如果需要深度 → 升级到 `tool-prompt-usp-demand-analysis`
