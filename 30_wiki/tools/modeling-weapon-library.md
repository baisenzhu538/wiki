...
- **C1 [conf=0.9]**: 常见模型武器库按问题难度将模型分为三层：基础模型、进阶模型、深度模型。——依据：10_raw/sources/src_20260614_73352fa5-Truman-高阶建模-抽象建模-常见模型武器库-图-01.md:7-49`。
- **C2 [conf=0.85]**: 基础模型适用于简单问题，核心功能是「合集、列表、执行、实操」，如案例包、清单、SOP、画布。——依据：10_raw/sources/src_20260614_73352fa5-Truman-高阶建模-抽象建模-常见模型武器库-图-01.md:18-28`。
- **C3 [conf=0.85]**: 进阶模型适用于更难问题，核心功能是「逻辑、分类、分级」，如雷达图、象限图、SABC 分级。——依据：10_raw/sources/src_20260614_73352fa5-Truman-高阶建模-抽象建模-常见模型武器库-图-01.md:19-27`。
- **C4 [conf=0.8]**: 深度模型适用于最难问题，核心功能是「洞察、创新、底层本质」，如三角图、冰山图、本质公式。——依据：10_raw/sources/src_20260614_73352fa5-Truman-高阶建模-抽象建模-常见模型武器库-图-01.md:20-29`。
- **C5 [conf=0.8]**: 模型选型的常见错误是难度错配：用清单解决复杂决策，或用本质公式解决执行问题。——推断：基于武器库分层逻辑。
- **C6 [conf=0.75]**: 同一模型可叠加使用，例如「SOP + 检查清单 + 画布」形成完整交付物。——依据：10_raw/sources/src_20260614_73352fa5-Truman-高阶建模-抽象建模-常见模型武器库-图-01.md`。
