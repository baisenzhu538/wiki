...
- **C2 [conf=0.9]**: 剧本基地必须包含七要素：题材、主角、核心欲望、核心阻碍、故事场景、情绪价值、目标平台 [conf=0.9]。
...
> **约翰·特鲁比（John Truby）** 在《故事写作大师班》中强调，伟大的剧本从"道德前提"和"人物欲望"出发，而非从"节点清单"出发。剧本策划三板斧如果被执行成填空表，可能让创作者忽视人物内在欲望的真实性和主题深度。
>
> **布莱克·斯奈德（Blake Snyder）** 的《救猫咪》 beat sheet 也提供 15 个节拍，但他反复强调节拍是"骨架"，真正让剧本活起来的是角色的"转化时刻"。三斧提供了骨架，但如果使用者不理解转化的必要性，只会得到骨架精美的尸体。
...
| 剧本基地已确定，开始写大纲 | 用"内容走向"列出 10-15 个关键节点，标注每节点功能（铺垫/冲突/反转/卡点） | 每个节点一句话，功能清晰 |
