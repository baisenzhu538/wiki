...
- [[tool-ban-fei-mao-you-xian-shi-yong-guan-fang-quan-wei-xin-yuan-zuo-zheng-ju]] — 追问证据后如何判断信源优先级的具体技能
- [[tool-ai-four-elements-validation]] — 纪浩的四要素验证，与半肥猫的证据追问同属前置判断
