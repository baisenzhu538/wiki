...
- **具体假设**：该工具假设"标准化报告模板能提升需求分析的质量和可传递性"，但模板的最大风险是"形式大于内容"——当分析者知道要按 TAM/SAM/CR1 的结构输出时，他们会把精力集中在"填模板"而非"思考问题"上，模板越完善，思考越懒惰。
- **边界**：在早期探索阶段（问题空间未定义时），固定模板反而有害——因为此时最重要的问题不在模板的任何字段中。
- **反例**：许多突破性的产品决策来自"模板之外"的洞察——Airbnb 的关键假设不是"TAM 有多大"，而是"陌生人愿意住在别人家里"——后者不在任何标准报告模板的字段中。

**Edward Tufte**（耶鲁大学统计学和政治学教授，《The Visual Display of Quantitative Information》作者）会质疑：报告模板把"复杂的需求分析"压缩为"有限的字段"，这个过程必然丢失信息。他的核心原则是"信息密度"——好的报告应该尽可能多地展示数据之间的关联，而非把数据塞入预设的格子中。模板的真正价值不在于"统一格式"，而在于"降低阅读者的认知成本"——但如果模板太死板，阅读者得到的不是"降低成本"而是"降低理解"。
