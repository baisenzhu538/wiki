...
**五设计师并行+设计规范复制（#396 补强，L2220-2266）**：工业化的进一步放大——"我是五个设计师同时上班的，就光做图这件事儿，我是五个设计师同时完成工作"（L2224）；每个 session 只需说一句"看一下设计规范，熟悉一下项目就可以干活"（L2230）；做完系列图后让 Agent 复盘写设计规范（L2246-2248）——规范=能力复制介质："我不只是把我的一个设计师的能力，我还可以用一个设计规范把我这边的设计师几乎一秒钟变成是另外一个同学的设计师的能力"（L2262）。100 张稿子靠"一个设计师+五个 Agent 分工"做出（L2264）。
