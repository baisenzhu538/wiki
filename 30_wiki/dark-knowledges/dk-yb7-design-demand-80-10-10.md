...
- **内部局限**：80-10-10 分层是设计服务市场一线体感——"运营驱动/高频低客单价"是特定市场结构（中国中小客户），跨市场（大客户/海外/品牌方）适用性有限；"调风格而非做设计"的表述对品牌设计业务不适用。
- **外部攻击（设计行业视角）**：80% 市场做"调风格"的判断会诱导设计师往低价值走——中国设计行业正在升级（品牌/体验/战略设计需求增长），分层是静态快照不是动态趋势；分层可能成为"设计师只配调风格"的自我设限。
