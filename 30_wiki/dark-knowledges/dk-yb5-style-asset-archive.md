...
- **内部局限**：风格资产工程化归档的前提是「企业已有可结构化的风格资产」——多数中小企业的风格资产散落在个人习惯里，没有 PS 工程文件；「反推结构体系」依赖高成本的专业人力，小团队做不起。
- **外部攻击（经济学视角）**：风格资产归档是「一次投入长期回报」的典型——但小企业现金流紧张时，归档成本（人力/时间）可能高于 AI 降本收益（边际递减）；且风格资产固化可能抑制风格创新（归档=冻结，企业需要持续更新资产库）。
