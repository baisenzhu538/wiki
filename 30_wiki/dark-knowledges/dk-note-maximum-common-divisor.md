...
- **内部局限**：清单体作为人机"最大公约数"依赖双方的清单理解——过度结构化会损失思考深度（清单化=降级，对复杂问题过度简化）；"结构降级即认知升级"是笔记场景观察，对深度创作（论文/书稿）不适用。
- **外部攻击（认知视角）**：清单体适合"人机协作执行"（AI 可解析）但可能损害"人的独立思考"（模板化思考习惯）——笔记的价值在"思考过程"而非"输出格式"；"最大公约数"本质是"最低共同标准"（AI 友好但人可能被拉低）；应区分"人思考用自由笔记"与"人机协作用清单体"。
