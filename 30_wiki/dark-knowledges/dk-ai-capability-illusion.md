...
> OpenClaw 数字员工搭建者（口述 L754-766, L448-456）

- 「AI 确实会给我们一种能力会变强、效率会起飞的错觉……我在部署 AIGC 整个环节里面，不需要自己学习模型、搭节点、做工作流，开心极了，却没有做好调研跟建立审美，导致我在一个不必要的地方耗费很多时间跟精力。」（L754-764）——能力错觉+方法把关被第二案例自述证实
