...
aliases:
  ...
  - 横图看不清
  - 空间叙事四大失败模式
  - 空间叙事四大失败模式：等距平铺/伪嵌套/横图看不清/构建者自审
  - 等距平铺
  - 等距平铺/伪嵌套/横图看不清/构建者自审
source_refs:
- 10_raw/sources/multimodal-output/王欢：把一个想法，做成一张会移动的无限画布/王欢：把一个想法，做成一张会移动的无限画布.md:48-51
- 10_raw/sources/multimodal-output/王欢：把一个想法，做成一张会移动的无限画布/王欢：把一个想法，做成一张会移动的无限画布.md:111-113
- 10_raw/sources/multimodal-output/王欢：把一个想法，做成一张会移动的无限画布/王欢：把一个想法，做成一张会移动的无限画布.md:139-143
- 10_raw/sources/multimodal-output/王欢：把一个想法，做成一张会移动的无限画布/王欢：把一个想法，做成一张会移动的无限画布.md:163-170
- 10_raw/sources/multimodal-output/王欢：把一个想法，做成一张会移动的无限画布/王欢：把一个想法，做成一张会移动的无限画布.md:269-274
related:
