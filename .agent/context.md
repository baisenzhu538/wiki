...
blockers:
  ...
  - "09-07 黄药师 #673 .obsidian 快照已裁定（老朱拍板恢复日拍）：待王语嫣编排黄药师施工——obsidian 快照移出周一分支恢复每日执行+头注释对齐「每日」+R1 skip echo 移非周一分支（决策记录：60_feedback/diagnosis/diag_20260907_ouyangfeng-bundle-bat-branch-structure.md 末节）"
